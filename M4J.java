...
public class M4J {
    ...
    public static List<Integer> getTingCards(int[] hand_cards, int gui_index) {
        ...
        for (int i = 0; i < 34; i++) {
            ...
            cards[i]++;
            if (get_hu_info(cards, i, gui_index).hu) {
                tingCards.add(i);
            }
            cards[i]--;
        }
    ...
    public static List<Integer> getAbcCards(int[] hand_cards, int gui_index) {
        List<Integer> abcCards = new ArrayList<>();
        ...
        for (int i = 0; i < 25; i++) {
            while (cards[i] > 0 && cards[i + 1] > 0 && cards[i + 2] > 0) {
                ...
                cards[i + 1]--;
                cards[i + 2]--;
                if (get_hu_info(cards, 34, gui_index).hu) {
                    abcCards.add(i);
                } else {
                    cards[i]++;
                    cards[i + 1]++;
    ...
    public static List<Integer> getAAACards(int[] hand_cards, int gui_index) {
        List<Integer> aaaCards = new ArrayList<>();
